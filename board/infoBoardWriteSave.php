...
<body>
    <?php    
        ...
        $sql = "INSERT INTO infoBoard(memberID, boardTitle, boardContents, youName,boardView, regTime) VALUES('$memberID', '$boardTitle', '$boardContents', '$youName','$boardView', '$regTime')";
        $connect -> query($sql);   

        Header("Location: ../board/infoBoard.php");
    ?>
</body>
</html>